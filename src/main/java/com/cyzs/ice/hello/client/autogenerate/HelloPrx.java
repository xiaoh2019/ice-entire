...
package com.cyzs.ice.hello.client.autogenerate;

public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    default String SayHello(String username)
    {
        return SayHello(username, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String SayHello(String username, java.util.Map<String, String> context)
    {
        return _iceI_SayHelloAsync(username, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String> SayHelloAsync(String username)
    {
        return _iceI_SayHelloAsync(username, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String> SayHelloAsync(String username, java.util.Map<String, String> context)
    {
        return _iceI_SayHelloAsync(username, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<String> _iceI_SayHelloAsync(String iceP_username, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "SayHello", null, sync, null);
